...
| ~~**G5-T3**~~ | ~~**Bing Webmaster Tools 등록**~~ | — | **✅ 완료 2026-07-28.** GSC 가져오기로 등록(별도 인증 불요). sitemap `Success`, **발견 URL 31 = 우리 sitemap과 일치**, 오류 0. **IndexNow 메뉴 접근 확인** — G2-T3 검증 창구 확보. `yohan-studio.vercel.app` 은 의도적으로 미가져옴(리디렉트 전용) |
