# Sol Advisor Luna / Max 카드뉴스 v5 문안

검증 기준: Sol Advisor v0.5.0 `main` README·오케스트레이션 계약, 로컬 Codex CLI 0.147.0 도움말.
...
1. Sol Advisor는 OpenAI 공식 기능이 아닌 커뮤니티 플러그인이며 Bun이 필요합니다.
2. Codex 앱 작업 도구가 필요하며 Native V2가 아닌 별도 앱 작업 방식입니다.
3. Luna 또는 Max를 사용할 수 없으면 다른 모델이나 추론 강도로 자동 대체하지 않고 중단합니다.
